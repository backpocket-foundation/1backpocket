...
public:
    ...
    void setupUi(QDialog *CoinControlDialog)
    {
        ...
        labelCoinControlAmount->setText(QStringLiteral("0.00 BCKT"));
        ...
        labelCoinControlFee->setText(QStringLiteral("0.00 BCKT"));
        ...
        labelCoinControlAfterFee->setText(QStringLiteral("0.00 BCKT"));
        ...
        labelCoinControlChange->setText(QStringLiteral("0.00 BCKT"));
